describe 'Expectation Matchers' do
    ...
    describe 'other useful matchers' do
        it 'will match a string with a regular expression' do
            ...
            expect(123).to_not match(/\d{3}/) # only works with strings
    ...
    describe 'predicate matchers' do
        it 'will match be_* to custom methods ending in ?' do
            ...
            # be_nil is also an example of a predicate matcher
        ...
        it 'will match have_* to custom methods like has_*?' do
            ...
            # Can use these when methods start with "has_", end in "?", and return true/false.
                # Can have arguments, but not required.
    ...
    describe 'observation matchers' do
        ...
        # It is a special block format that allows a process to take
            # place inside of the expectation
        ...
        it 'will match when errors are raised' do
            ...
            # Note that the negative form does not accept any arguments
